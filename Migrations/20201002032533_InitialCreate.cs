    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BeekeeperId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    BeekeeperName = table.Column<string>(nullable: true),
                    Password = table.Column<string>(nullable: true),
                    ProfilePicture = table.Column<string>(nullable: true),
                    ApiaryAddress = table.Column<string>(nullable: true),
                    ContactInfo = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Beekeepers", x => x.BeekeeperId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ApiaryId = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ApiaryName = table.Column<string>(nullable: true),
                    BeekeeperId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apiaries_Beekeepers_BeekeeperId",
                        column: x => x.BeekeeperId,
                        principalTable: "Beekeepers",
                        principalColumn: "BeekeeperId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InspectionResults = table.Column<string>(nullable: true),
                    Health = table.Column<string>(nullable: true),
                    HoneyStores = table.Column<string>(nullable: true),
                    QueenProduction = table.Column<string>(nullable: true),
                    ...
                    Gains = table.Column<string>(nullable: true),
                    ApiaryId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
